...
- [ ] Read: [JavaScript.info - Async/Await](https://javascript.info/async-await)
- [ ] Understand: Why async/await is better than .then()
...
### Afternoon Session (HH:MM - HH:MM)
- [ ] Task 1
- [ ] Task 2

**Code written:** [GitHub commit link]
...
- [ ] Write async/await code without looking at docs
- [ ] Handle loading/error states in React confidently
- [ ] Type React components in TypeScript (props, state, events)
- [ ] Use React DevTools to debug issues
- [ ] Build a full CRUD app with API integration
- [ ] Explain closures and `this` (you'll learn them through practice)

### Deliverables Portfolio:

1. ✅ Weather App (deployed)
2. ✅ TODO App with API (deployed, TypeScript)
3. ✅ GitHub with clean commits
4. ✅ Personal notes/cheat sheets
...
- If stuck >20 min → ask ChatGPT/Claude
- If still stuck >40 min → move to next task, return tomorrow
...
- 30 min minimum
- Better daily practice than 6h once a week
...
- Struggled with: Promise chaining
- Aha moment: .then() returns new Promise!
```

### 5. **English Practice**

- Write all code comments in English
- Name variables/functions in English
...
2. **Video (if stuck):**
    ...
    - Fireship (short explanations)
3. **AI Help:**
    
    - Claude / ChatGPT for code review
    - Explain error messages
4. **Me (your mentor):**
    
    - If fundamentally confused
    - For code review
    - For motivation when struggling
...
- [ ] Can handle loading/error in React
- [ ] Understand async/await flow
- [ ] Comfortable with React DevTools
- [ ] Built 1 complete app (Weather)

### Week 2 Completion:

- [ ] Can type React components
- [ ] Understand generics basics
- [ ] Know common utility types
- [ ] Built 1 TypeScript + React app (TODO)
- [ ] **Ready to start real projects**
...
Этот план **интенсивный**, но выполнимый. Ключевые правила:

1. **Не пропускай дни** — лучше 1 час каждый день, чем 7 часов в воскресенье
2. **Пиши код руками** — не копипасть, а печатай сам
3. **Делай ошибки** — чем больше багов найдёшь сам, тем лучше запомнишь
4. **Commit каждый день** — даже если код так себе, коммить в GitHub
5. **Отдыхай** — если совсем выгорел, возьми 1 день off, но не больше

После этих 2 недель ты закроешь **самые критичные пробелы** из интервью. Async JS и TypeScript будут на уровне, который позволит откликаться на вакансии.

---

**Готов начать?** Скажи "Day 1 start" когда будешь готов, и я дам детальный разбор первого дня с конкретными ресурсами и задачами.
